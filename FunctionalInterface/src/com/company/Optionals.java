...
public class Optionals {
    ...
    public static void doOptionalNull() {
        ...
        Supplier<String> stringSupplierL = () -> "Empty optional";



        Optional<String> optNull = howToDealWithNull(null);
        optNull.ifPresent(s -> System.out.printf(s));
        System.out.println(
                optNull.orElseGet(
                        stringSupplierL));// Empty optional

        Optional<String> optNull2 = howToDealWithNull(null);
        System.out.println(optNull2.orElseGet(stringSupplierL));

        String result = optNull
                .map(s -> "Wartość z optionala: " + s)
                .orElseGet(() -> "Brak wartości: " + stringSupplierL.get());
        ...
        Function<String, String> stringFunctionL = s -> "Wartość z optionala: " + s;
        ...
        Supplier<String> supplierL = () -> "Brak wartości: " + stringSupplierL.get();
