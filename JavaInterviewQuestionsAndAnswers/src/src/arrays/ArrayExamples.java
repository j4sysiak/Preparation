...
public class ArrayExamples {
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(marks5)); // [I@6db3f829
		System.out.println(Arrays.toString(marks5));// [25, 30, 50, 10, 5]

		// Printing a 2D Array
		int[][] matrix3 = { { 1, 2, 3 }, { 4, 5, 6 } };
		System.out.println(Arrays.deepToString(matrix3)); // [[I@1d5a0305
		...
		System.out.println(Arrays.toString(matrix3[0]));// [I@86c347
